...
from .models import Category, City, Order, OrderItem, Product, Offer
from common.admin import *

class OfferInline(admin.TabularInline):
    model = Offer
    fields = ('title', 'price', 'old_price', 'article', 'quantity', 'order','city')
    extra = 1
...
class ProductAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ('categories','city')
